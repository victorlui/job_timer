...
class ProjectServicesImpl implements ProjectService {
  final ProjectRepository _projectRepository;

  ProjectServicesImpl({required ProjectRepository projectRepository})
  ...
  Future<void> register(ProjectModel projectModel) async {
    final project = Project()
      ...
      ..estimated = projectModel.estimated;
  ...
  Future<void> finishProject(int id) async {
    _projectRepository.finishProject(id);
  }
}
