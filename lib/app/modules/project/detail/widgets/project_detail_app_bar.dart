                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Visibility(
                            ...
                            replacement: const Text('Project Finalizado'),
                            child: NewTasks(
...
class NewTasks extends StatelessWidget {
  ...
  const NewTasks({Key? key, required this.projectModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        Modular.get<ProjectDetailController>().updatePrject();
      },
      child: Row(
        children: [
          Padding(
