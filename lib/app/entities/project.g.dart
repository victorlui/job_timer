...
const ProjectSchema = CollectionSchema(
  name: 'Project',
  schema:
      '{"name":"Project","idName":"id","properties":[{"name":"estimated","type":"Long"},{"name":"name","type":"String"},{"name":"status","type":"Long"}],"indexes":[],"links":[{"name":"tasks","target":"ProjectTask"}]}',
  idName: 'id',
  propertyIds: {'estimated': 0, 'name': 1, 'status': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {'tasks': 0},
...
void _projectSerializeNative(
    ...
    AdapterAlloc alloc) {
  var dynamicSize = 0;
  final value0 = object.estimated;
  final _estimated = value0;
  ...
  writer.writeLong(offsets[0], _estimated);
...
Project _projectDeserializeNative(IsarCollection<Project> collection, int id,
  ...
  object.estimated = reader.readLong(offsets[0]);
  object.id = id;
...
dynamic _projectSerializeWeb(
  ...
  IsarNative.jsObjectSet(jsObj, 'estimated', object.estimated);
...
Project _projectDeserializeWeb(
  ...
  final object = Project();
  object.estimated =
      IsarNative.jsObjectGet(jsObj, 'estimated') ?? double.negativeInfinity;
...
P _projectDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    case 'estimated':
      return (IsarNative.jsObjectGet(jsObj, 'estimated') ??
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> estimatedEqualTo(
      int value) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> estimatedGreaterThan(
    int value, {
    bool include = false,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> estimatedLessThan(
    int value, {
    bool include = false,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> estimatedBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectQueryWhereSortBy on QueryBuilder<Project, Project, QSortBy> {
  QueryBuilder<Project, Project, QAfterSortBy> sortByEstimated() {
    return addSortByInternal('estimated', Sort.asc);
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByEstimatedDesc() {
    return addSortByInternal('estimated', Sort.desc);
  }
...
extension ProjectQueryWhereSortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByEstimated() {
    return addSortByInternal('estimated', Sort.asc);
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByEstimatedDesc() {
    return addSortByInternal('estimated', Sort.desc);
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByEstimated() {
    return addDistinctByInternal('estimated');
  }
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, int, QQueryOperations> estimatedProperty() {
    return addPropertyNameInternal('estimated');
  }
